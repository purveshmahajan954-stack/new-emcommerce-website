...
const DATABASE_URL = process.env.DATABASE_URL || 'postgresql://postgres:makhana%40%2312345@db.rpyibuyljbbtxyqaxnlt.supabase.co:5432/postgres';
...
app.use(
  session({
    secret: process.env.SESSION_SECRET || 'rituals-dev-secret-2025',
    resave: false,
